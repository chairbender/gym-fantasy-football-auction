...
setup(name='gym_fantasy_football_auction',
      ...
      download_url='https://github.com/chairbender/gym-fantasy-football-auction/archive/1.06.tar.gz',
      install_requires=['gym>=0.7.4', 'fantasy_football_auction>=0.9.96', 'six>=1.11.0', 'numpy>=1.13.1'],
